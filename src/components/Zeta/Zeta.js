...
const Zeta = () => {
    ...
    return(
        ...
        <div className={toggleState === 3 ? "color-name" : "hide"}>METALLIC MAGMA GREY</div>
        <div className={toggleState === 4 ? "color-name" : "hide"}>BURGUNDY RED</div>
        <div className="nav-type">
            <div className={toggleState === 1 ? "color active" : "color"} onClick={()=>toggleTab(1)} style={{backgroundColor:'white'}}></div>
            <div className={toggleState === 2 ? "color active" : "color"} onClick={()=>toggleTab(2)} style={{backgroundColor:'black'}}></div>
            <div className={toggleState === 3 ? "color active" : "color"} onClick={()=>toggleTab(3)} style={{backgroundColor:'#797979'}}></div>
            <div className={toggleState === 4 ? "color active" : "color"} onClick={()=>toggleTab(4)} style={{backgroundColor:'#534050'}}></div>
        </div>
        </>
    )
}
